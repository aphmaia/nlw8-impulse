    ...
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        <textarea
          ...
          className="min-w-[304px] w-full min-h-[112px] text-sm placeholder-zinc-400 text-zinc-100 border-zinc-600 bg-transparent focus:outline-none resize-none rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
